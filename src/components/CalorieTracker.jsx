...
const CalorieTracker = () => {
  ...
  useEffect(() => {
    ...
    const fetchFoods = async () => {
      ...
      const res = await fetch(
        `https://eatwise-backend-39j2.onrender.com/foods?search=${searchKey}`,
      );
  ...
  useEffect(() => {
    ...
    const fetchLogs = async () => {
      try {
        const res = await fetch(
          `https://eatwise-backend-39j2.onrender.com/calorie-log/${user.id}`,
        );
        const data = await res.json();
  ...
  const addFood = async () => {
    ...
    try {
      const res = await fetch(
        "https://eatwise-backend-39j2.onrender.com/calorie-log",
        {
          method: "POST",
          headers: {
